...
достаёт лишь 5.1×, обвалившись до 1.8 МБ/с сжатия:
...
~20× скорости кодирования; quoin-Balanced меняет каплю ratio на ~50× более быстрое
...
**~210× быстрее** и распаковывая **~2.4× быстрее**:
...
ratio**: на decimal `city_temperature` quoin-Balanced даёт 13.3× при **121 МБ/с**
сжатия против 14.3× у `zstd -19` при **2.3 МБ/с** — ~50× быстрее кодирование при

...
### Ratio и пропускная способность при разных объёмах

Одна и та же реальная колонка (`arade4`, 9.9 млн doubles), усечённая до набора
размеров:

![ratio и скорость распаковки vs размер колонки](docs/images/volume_sweep.png)

Полная колонка (9.9 млн значений):

| кодек | ratio | сжатие МБ/с | распаковка МБ/с |
| --- | ---: | ---: | ---: |
...
Верхний правый угол — лучший; quoin даёт и наивысший ratio, *и* декод в несколько
ГБ/с:

![Pareto-фронт декода](docs/images/pareto.png)
